...
import cn.swallow.platform.core.aop.RequestModel;
import cn.swallow.platform.core.util.http.HttpServletUtil;
import cn.swallow.platform.core.util.json.JacksonUtil;
import cn.swallow.platform.core.util.xml.XmlMapper;
...
public class WebApiInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
        ...
        if (StringUtils.equalsAny(contentType,
            ...
            String reqBody = HttpServletUtil.getBodyString(request);
            reqParams.append("\nBody:").append(reqBody);
        }
