...
import cn.swallow.platform.core.interceptor.SwallowUserFilter;
import cn.swallow.platform.core.shiro.ShiroDBRealm;
...
//    }
     ...
     * @param swallowProperties
     * @return
     */
    @Bean
    @ConditionalOnProperty(prefix = "swallow", name = "spring-session-open", havingValue = "false")
    public DefaultWebSessionManager defaultWebSessionManager(CacheManager cacheShiroManager, SwallowProperties swallowProperties) {
        DefaultWebSessionManager sessionManager = new DefaultWebSessionManager();
        sessionManager.setCacheManager(cacheShiroManager);
        sessionManager.setSessionValidationInterval(swallowProperties.getSessionValidationInterval() * 1000);
        sessionManager.setGlobalSessionTimeout(swallowProperties.getSessionInvalidateTime() * 1000);
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager) {
        ...
        myFilters.put("user", new SwallowUserFilter());
